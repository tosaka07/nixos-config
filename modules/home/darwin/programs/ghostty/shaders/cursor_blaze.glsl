...
const vec4 TRAIL_COLOR = vec4(0.384, 0.400, 0.439, 1.0); // Catppuccin Mocha Surface1 (#45475a) - より暗い
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0.267, 0.369, 0.565, 1.0); // Catppuccin Mocha Blue の暗い版 (#445e90)
